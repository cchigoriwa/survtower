...
import com.survtower.business.central.service.MemberDetailService;
...
public class MemberDetailServiceImpl implements MemberDetailService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        MemberSecurity memberSecurity = memberSecurityService.findByEmailAddress(username);
        if (memberSecurity == null) {
            throw new UsernameNotFoundException("User " + username + " not found.");
        } else {
            return memberSecurity.toUserDetails();
        }
