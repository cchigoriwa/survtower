...
@ManagedBean
@ViewScoped
public class RegionDataEntryEditControllerTest extends MessageInfor implements Serializable {

    public RegionDataEntryEditControllerTest() {
    }
    ...
    @ManagedProperty(value = "#{regionDataEntryProcess}")
    private RegionDataEntryProcess regionDataEntryProcess;
    ...
    public RegionDataEntryProcess getRegionDataEntryProcess() {
        return regionDataEntryProcess;
    }

    public void setRegionDataEntryProcess(RegionDataEntryProcess regionDataEntryProcess) {
        this.regionDataEntryProcess = regionDataEntryProcess;
    }
    ...
    public void loadData() {
        ...
        regionSurveillanceDataList = regionDataEntryProcess.loadRegionData(programId, periodId, regionId);
